...
function buildCharts(organization, newPara) {
    ...
    d3.json("/metrics").then((data) => {
      ...
      var selectedPara = filteredData.slice(0,15).map(record =>  record.newPara);
      ...
      var layout ={
          title:`<b> Top 15 Charities in : ${organization} CateGory </b>`,
      ...
      // var pie_labels = data.organization_type;
      // var pie_hover = data.organization_type;
